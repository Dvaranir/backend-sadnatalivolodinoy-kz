...
export interface ApiOrderPlantOrderPlant extends Struct.CollectionTypeSchema {
  collectionName: 'order_plants';
  info: {
    displayName: 'OrderPlant';
    pluralName: 'order-plants';
    singularName: 'order-plant';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiPageHomePageHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    contactsSectionHeading: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::order-plant.order-plant': ApiOrderPlantOrderPlant;
